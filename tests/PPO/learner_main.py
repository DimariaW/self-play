from tests.PPO.config import CONFIG, MEMORY_ADDRESS, MODEL_SERVER_ADDRESS, LEAGUE_ADDRESS
from tests.PPO.learner import MemoryMain, LearnerMain, LeagueMain, ModelServerMain
